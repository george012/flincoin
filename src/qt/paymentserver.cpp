...
void PaymentServer::ipcParseCommandLine(int argc, char* argv[])
{
    for (int i = 1; i < argc; i++)
    {
        ...
        else if (QFile::exists(arg)) // Filename
        {
            ...
            {
                if (request.getDetails().genesis() == "e02a0efbcf285b547b144b0872558aba52c4e1ff33c4658cb0a086583f2e9ec8")
                {
                    SelectParams(CBaseChainParams::MAIN);
                }
                else if (request.getDetails().genesis() == "6336fbd5d723241e039542f49576a07bc1b080d5e5de48f47babf42a0565aa43")
                {
                    SelectParams(CBaseChainParams::TESTNET);
                }
            }
