...
// Copyright (c) 2020-2023 The Flincoin Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Flincoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Flincoin (as there is no actual maximum coins)
