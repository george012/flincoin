...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Flincoin Core repository on GitHub"),
        tr("Services that claim to double your flincoins are always ponzi schemes")
    };
