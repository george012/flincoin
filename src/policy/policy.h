...
/** Recommended transaction fee by Flincoin Core developers
  *
 ...
 *
 *  Flincoin:    Increment mempool limits and accept RBF in steps of 0.0001 FLIN
...
/**
 * Flincoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Flincoin: Default hard dust limit that is evaluated when considering whether
