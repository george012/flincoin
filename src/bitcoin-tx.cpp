...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s flincoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  flincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded flincoin transaction") + "\n" +
              "  flincoin-tx [options] -create [commands]   " + _("Create hex-encoded flincoin transaction") + "\n" +
              "\n";
