...
const char * const BITCOIN_CONF_FILENAME = "flincoin.conf";
const char * const BITCOIN_PID_FILENAME = "flincoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Flincoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Flincoin";
#else
    // Unix
    return pathRet / ".flincoin";
#endif
#endif
}
